...
return array(
    ...
    // 1-й (обязательный) - имя компонента. Можно также установить в false, если необходимо просто закрепить алиас для пользовательского шаблона
    // 2-й (необязательный) - разрешить общий доступ к странице (по умолчанию false - только для авторизованных пользователей)
    'url_aliases' => array(
        // ...
        ...
        // на пользовательские алиасы будет иметь непредсказуемый результат!
    ),
